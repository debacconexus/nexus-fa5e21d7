...
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Client Consultation Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "client_consultation_record_records";
'use strict';
